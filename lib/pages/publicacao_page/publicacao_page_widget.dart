...
import 'publicacao_page_model.dart';
export 'publicacao_page_model.dart';

class PublicacaoPageWidget extends StatefulWidget {
  const PublicacaoPageWidget({
    super.key,
  ...
  @override
  State<PublicacaoPageWidget> createState() => _PublicacaoPageWidgetState();
}

class _PublicacaoPageWidgetState extends State<PublicacaoPageWidget>
    with TickerProviderStateMixin {
  late PublicacaoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PublicacaoPageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PostsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final publicacaoPagePostsRecord = snapshot.data!;
                                                  ...
                                                  ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      valueOrDefault<String>(
                                                        publicacaoPagePostsRecord
                                                            .postUserImage,
                                                        'https://cdn-icons-png.flaticon.com/128/4211/4211178.png',
                                                      ),
                                                      width: 40.0,
                                                      height: 40.0,
                                                      fit: BoxFit.cover,
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              '@${publicacaoPagePostsRecord.postUserName}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelSmall
                                                                  .override(
                                                                        ...
                                                                        var confirmDialogResponse = await showDialog<bool>(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return AlertDialog(
                                                                                  ...
                                                                                  content: const Text('Deseja realmente excluir esse comentário?'),
                                                                                  actions: [
                                                                                    TextButton(
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                listViewCommentsRecord.commentUserName,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        ToggleIcon(
                                                                          onPressed:
                                                                            ...
                                                                            final commentLikesElement =
                                                                                currentUserReference;
                                                                            final commentLikesUpdate = listViewCommentsRecord.commentLikes.contains(commentLikesElement)
                                                                                ? FieldValue.arrayRemove([
                                                                                    commentLikesElement
                                                                                  ])
                                                                                : FieldValue.arrayUnion([
                                                                            ...
                                                                            await listViewCommentsRecord.reference.update({
                                                                              ...mapToFirestore(
                                                                                {
                                                                                  'commentLikes': commentLikesUpdate,
                                                                                },
                                                                              ),
                                                                            });
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            listViewCommentsRecord.commentLikes.length.toString(),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  fontFamily: 'Readex Pro',
                                                                                  letterSpacing: 0.0,
                                                                                ),
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          await publicacaoPagePostsRecord
                                              .reference
                                              .update({
                                            ...mapToFirestore(
                                              {
