...
import 'configuracoes_perfil_model.dart';
export 'configuracoes_perfil_model.dart';

class ConfiguracoesPerfilWidget extends StatefulWidget {
  const ConfiguracoesPerfilWidget({super.key});

  @override
  State<ConfiguracoesPerfilWidget> createState() =>
      _ConfiguracoesPerfilWidgetState();
}

class _ConfiguracoesPerfilWidgetState extends State<ConfiguracoesPerfilWidget> {
  late ConfiguracoesPerfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfiguracoesPerfilModel());
                            ...
                            child: Container(
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  ...
                                  'https://cdn-icons-png.flaticon.com/128/8238/8238768.png',
                                ),
                                fit: BoxFit.cover,
                              ),
                            ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'adicione uma biografia',
                          hintStyle:
                              FlutterFlowTheme.of(context).labelMedium.override(
                                    fontFamily: 'Readex Pro',
                                    letterSpacing: 0.0,
                        ...
                        onPressed: ((_model.nameTextController.text == '') &&
                            ...
                            : () async {
                                await currentUserReference!
                                  ...
                                  userName: _model.userNameTextController1.text,
                                  bio: _model.userNameTextController2.text,
                                ));
